...
if page == "Phân Tích Sản Phẩm":
    ...
    def update_area_charts():
        if apply_filters_to_area_charts:
            ...
            simulation_data_platform_filtered = normalize_filtered_data(
                simulation_data_platform, 'Platform', selected_platforms
            )
            simulation_data_product_filtered = normalize_filtered_data(
                simulation_data_product, 'Product', selected_products
            )
        else:
            # Không áp dụng bộ lọc, sử dụng dữ liệu ban đầu
            simulation_data_platform_filtered = simulation_data_platform
            simulation_data_product_filtered = simulation_data_product

        # Biểu đồ miền cho nền tảng
        ...
        # Biểu đồ miền cho loại sản phẩm
        ...
        # Hiển thị biểu đồ miền đã cập nhật
